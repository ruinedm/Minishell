...
UTILS = utils/ft_atoi.c utils/ft_itoa.c utils/ft_split.c utils/ft_strchr.c utils/ft_strcmp.c utils/ft_strcpy.c utils/ft_strdup.c utils/ft_strjoin.c utils/ft_strlcpy.c utils/ft_strlen.c utils/ft_strncmp.c utils/ft_strncpy.c utils/ft_substr.c utils/print_helper.c utils/ft_isalpha.c utils/is_c_num.c utils/better_access.c utils/ft_strcasecmp.c utils/ft_split_ws.c utils/is_ws.c
AST = ast/linked_list_ast.c ast/ruined_tree.c
...
GC = anti_leaks/cgc.c anti_leaks/linked_list_utils.c anti_leaks/keep_track.c anti_leaks/fdc.c
